 ...
 * @author ASUS
 */
public class TambahBarangSewa extends javax.swing.JFrame {

    /**
     * Creates new form LandingPage
     */
    public TambahBarangSewa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tambah Barang Sewa");
        ...
        jLabel12.setText("Gambar Barang :");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TambahBarangSewa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TambahBarangSewa().setVisible(true);
            }
        });
    }
